...
Route::controller(AgentController::class)->middleware('auth', 'agent')->group(function () {
    ...
    Route::get('/agent/message', [SubscriptionController::class, 'user_message'])->name('user.message');


    // Route::get('/agent/appointment', [SubscriptionController::class, 'user_appointment'])->name('user.appointment');

    // Route::get('/agent/booking', [SubscriptionController::class, 'user_booking'])->name('agent.booking');
    ...
    Route::get('/agent/account', [ProfileController::class, 'user_account'])->name('user.account');
