...
@section('title', get_phrase('Hotel Listings'))
    ...
    <div class="container">
        <div class="row row-28 mb-80">
            ...
            <div class="col-xl-3 col-lg-4">
                @include('frontend.sidebar_real-estate')
            </div>
            <!-- Right Content Area -->
                                    ...
                                    <div class="reals-list-details">
                                        <div class="realsl-location-title-price d-flex justify-content-between">
                                            <div class="realsl-location-title">
                                                ...
                                                <a href="{{route('listing.details',['type'=>$type, 'id'=>$listing->id, 'slug'=>slugify($listing->title)])}}" class="title line-2"> {{$listing->title}} </a>
                                                <p class="info line-2"> {{substr_replace($listing->description, "...", 100)}}</p>
                                            </div>
