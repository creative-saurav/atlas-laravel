    ...
    <div class="container">
        <div class="row row-28 mb-80">
            ...
            <div class="col-xl-3 col-lg-4">
                @include('frontend.sidebar_hotel')
            </div>
            <!-- Right Content Area -->
                                ...
                                <div class="single-grid-card">
                                    ...
                                    <div class="hotel-grid-details">
                                        ...
                                        <ul class="hotelgrid-list-items d-flex align-items-center flex-wrap">
                                            ...
                                            {{-- <li class="more">+{{isset($more_amenities)?$more_amenities-2:}} More</li> --}}
                                        </ul>
                                        <div class="hotelgrid-see-price d-flex align-items-center justify-content-between">
                                            <a href="{{route('listing.details',['type'=>$type, 'id'=>$listing->id, 'slug'=>slugify($listing->title)])}}" class="see-details-btn1">{{get_phrase('See Details')}}</a>
