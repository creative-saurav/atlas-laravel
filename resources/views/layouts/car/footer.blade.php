<!-- Start Footer Area -->
<footer class="main-footer-section ca-footer-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!-- Footer Top Area -->
                <div class="footer-top-area at-footer-top-area d-flex justify-content-between flex-wrap">
                    <div class="footer-top-details at-footer-top-details ca-footer-top-details">
                    ...
                    <div class="footer-search">
                        <form action="">
                            <div class="footer-input-wrap at-footer-input-wrap ca-footer-input-wrap">
                ...
                <div class="footer-middle-area d-flex justify-content-between flex-wrap">
                    <div class="footer-middle-logo">
                        <a href="#"><img ssrc="{{ asset('public/assets/frontend/images/at-home-logo2.svg') }}" alt="logo"></a>
                        <p class="info">Lorem ipsum dolor sit amet, consectetur they adipiscing elit ut aliquam, purus sit amet luctus venenatis.</p>
                    </div>
                    <div class="footer-middle-nav at-footer-middle-nav ca-footer-middle-nav">
                    ...
                    <div class="footer-middle-contact footer-middle-nav at-footer-middle-nav ca-footer-middle-nav">
    ...
    <div class="footer-bottom-area at-footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-bottom-wrap at-footer-bottom-wrap ca-footer-bottom-wrap d-flex align-items-center justify-content-between flex-wrap">
                        <p class="info">© Copyright by CodedUI. All rights reserved.</p>
                        <div class="footer-bottom-social at-footer-bottom-social ca-footer-bottom-social">
