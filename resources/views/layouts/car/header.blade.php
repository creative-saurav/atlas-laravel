                            ...
                            <div class="offcanvas-body">
                                <nav>
                                    <ul class="at-home-navbar-nav bt-home-navbar-nav">
                                        ...
                                        <li><a href="#" class="at-home-nav-link ">{{get_phrase('Listing')}}</a></li>
                                ...
                                <form class="at-home-search-form" action="">
                                   <div class="at-home-nav-label">
                                        ...
                                        <button type="submit" class="at-home-search-btn ca-home-search-btn">
                                            <img src="{{asset('public/assets/frontend/images/icons/search-white-16.svg')}}" alt="">
                                        </button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="dropdown-menu user-dropdown-menu">
                                    ...
                                    <div class="px-10px py-12px">
                                        <a href="#" class="user-dropdown-item">
                                            ...
                                            <span class="mt-2px">Log Out</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <a href="#" class="btn ca-btn-dark at-home-listing-btn d-flex align-items-center gap-2">
                                <img src="assets/images/icons/plus-white-8.svg" alt="icon">
