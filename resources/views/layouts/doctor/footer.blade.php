<!-- Start Footer Area -->
<footer class="main-footer-section dt-footer-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!-- Footer Top Area -->
                <div class="footer-top-area at-footer-top-area d-flex justify-content-between flex-wrap">
                    <div class="footer-top-details at-footer-top-details dt-footer-top-details">
                    ...
                    <div class="footer-search">
                        <form action="">
                            <div class="footer-input-wrap at-footer-input-wrap dt-footer-input-wrap">
                ...
                <div class="footer-middle-area d-flex justify-content-between flex-wrap">
                    ...
                    <div class="footer-middle-nav at-footer-middle-nav dt-footer-middle-nav">
                    ...
                    <div class="footer-middle-contact footer-middle-nav at-footer-middle-nav dt-footer-middle-nav">
    ...
    <div class="footer-bottom-area at-footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-bottom-wrap at-footer-bottom-wrap dt-footer-bottom-wrap d-flex align-items-center justify-content-between flex-wrap">
                        <p class="info">© Copyright by CodedUI. All rights reserved.</p>
                        <div class="footer-bottom-social at-footer-bottom-social dt-footer-bottom-social">
