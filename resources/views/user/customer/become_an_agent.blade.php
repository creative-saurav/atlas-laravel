...
@section('title', get_phrase('Become an agent'))
                                ...
                                <div class="d-flex flex-column h-100 justify-content-between">
                                    <div>
                                        ...
                                        <ul class="d-flex flex-column gap-12px mb-3">
                                            ...
                                            <li class="at-check-listitem fs-14px  {{$package->choice == 1?'text-white':''}}"> {{$package->category.' '.get_phrase('Categorys par listing')}} </li>
                                    ...
                                    @else
                                        <a href="{{route('user.payment.index',['id'=>$package->id])}}" class="ad-pricing-card-btn">{{get_phrase('Try Now')}}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
