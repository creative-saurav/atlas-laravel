...
@section('title', get_phrase('Customer Appointment'))
                                ...
                                <tr class="ca-tr">
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="modal('modal-md', '{{route('customer.appointment.view_details',['id'=>$appointment->id, 'type'=>'zoom'])}}', '{{get_phrase('Customer Email Address')}}')">{{get_phrase('Metting Link')}}</a></li>
                                            @endif
