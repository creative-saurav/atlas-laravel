                                    ...
                                    <label class="form-check-label w-100" onclick="room_select('{{$key}}')" for="flckDefault{{$key}}">
                                        <div class="card mb-3 room-checkbox">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-8 room-body fs-14px">
                                                    <div class="card-body py-0 px-2 h-100 position-relative">
                                                        ...
                                                        <div class="text-end position-absulate">
                                                            <a href="javascript:void(0);" onclick="modal('modal-xl', '{{route('admin.add.listing.room',['prefix'=>'agent','id'=>$listing->id,'room_id'=>$room->id, 'page'=>'edit'])}}', '{{get_phrase('Update Room')}}')" class="p-1"> <i class="fas fa-edit"></i> </a>
                                                            <a href="javascript:void(0);" onclick="delete_modal('{{route('admin.delete.listing.room',['prefix'=>'agent','id'=>$room->id,'listing_id'=>$listing->id])}}')" class="p-1"> <i class="fas fa-trash-alt"></i> </a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="possition_relative" id="image-icon{{$key}}">
                                            ...
                                            <a href="javascript:void(0);" onclick="listing_image_delete('{{route('admin.listing.image.delete',['prefix'=>'agent','type'=>$listing->type,'id'=>$listing->id, 'image'=>$image])}}', '{{$key}}')"> <i class="fas fa-times"></i> </a>
                                        </div>
                                        @endforeach
