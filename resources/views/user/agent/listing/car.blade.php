...
<div class="ca-content-card p-4">
    ...
    <form action="{{route('user.listing.store',['type'=>'car'])}}" id="form-action" method="post" enctype="multipart/form-data">
        @csrf
