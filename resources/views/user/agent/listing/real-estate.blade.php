<div class="ca-content-card p-4">
    ...
    <form action="{{route('user.listing.store',['type'=>'real-estate'])}}" id="form-action" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            ...
                            <input type="number" name="garage" id="garage" class="form-control cap-form-control" placeholder="{{get_phrase('Enter floar size')}}" >
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <label for="year" class="form-label cap-form-label"> {{get_phrase('Year')}} *</label>
                            <input type="number" name="year" id="year" class="form-control cap-form-control" placeholder="{{get_phrase('Enter floar size')}}" >
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <label for="visibility" class="form-label cap-form-label"> {{get_phrase('Visibility')}} *</label>
                            <select name="visibility" id="visibility" class="form-control cap-form-control ol-select2" required data-minimum-results-for-search="Infinity">
