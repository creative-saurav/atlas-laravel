                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show {{$tab == 'basic' ? 'active':''}}" id="pills-basic-info" role="tabpanel" aria-labelledby="pills-basic-info-tab" tabindex="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-2">
                                            <label for="cyelinder" class="form-label cap-form-label"> {{get_phrase('Cyelinder')}} *</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-2">
                                            <label for="discount_price" class="form-label cap-form-label"> {{get_phrase('discount_price')}} *</label>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div id="map" class="rounded w-100" style="height: 400px;"></div>
                                </div>
                            </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            ...
                                            <div class="buttons w-25 d-flex justify-content-end">
                                                <a onclick="delete_modal('{{route('admin.delete.listing.specification',['prefix'=>'agent','id'=>$listing->id, 'specification_id'=>$specification->id])}}')" href="jacascript:void(0);"> <i class="fas fa-trash"></i> </a>
            
                                                <a onclick="modal('modal-md', '{{route('admin.edit.listing.specification',['prefix'=>'agent','id'=>$listing->id, 'specification_id'=>$specification->id])}}', '{{get_phrase('Update Specification')}}')" href="javascript:void(0);"> <i class="fas fa-pen"></i> </a>
            
                                                <a onclick="modal('modal-md', '{{route('admin.add.listing.sub-specification',['prefix'=>'agent','id'=>$listing->id, 'specification_id'=>$specification->id])}}', '{{get_phrase('Add New Sub Specification')}}')" href="javascript:void(0);"> <i class="fas fa-plus"></i> </a>
                                            </div>
                                        </h2>
                                                ...
                                                @foreach (App\Models\Listing_Specification::where('listing_id', $listing->id)->where('specification_id', $specification->id)->get() as $item)
                                                    <li class="p-2 ms-5 sub-feature">
                                                        ...
                                                        <div class="buttons">
                                                            ...
                                                            <a onclick="modal('modal-md', '{{route('admin.edit.listing.sub-specification',['prefix'=>'agent','id'=>$listing->id, 'specification_id'=>$item->id, 'parent'=>$specification->id])}}', '{{get_phrase('Update Sub Specification')}}')" href="javascript:void(0);"> <i class="fas fa-pen"></i> </a>

                                                            <a onclick="delete_modal('{{route('admin.delete.listing.specification',['prefix'=>'agent','id'=>$listing->id, 'specification_id'=>$item->id])}}')" href="javascript:void(0);" class=""> <i class="fas fa-trash"></i> </a>
                                                        </div>
                                                    </li>                                     
                                                @endforeach
                                            </ul>
                            ...
                            <div class="tab-pane fade show {{$tab == 'feature' ? 'active':''}}" id="pills-features" role="tabpanel" aria-labelledby="pills-features-tab" tabindex="0">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="fs-16px title"> {{get_phrase('Add some listng features')}} </h5>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            ...
                                            <div class="buttons w-25 d-flex justify-content-end">
                                                <a onclick="delete_modal('{{route('admin.listing.feature.delete',['prefix'=>'agent','id'=>$listing->id, 'feature_id'=>$feature->id])}}')" href="jacascript:void(0);"> <i class="fas fa-trash"></i> </a>
            
                                                <a onclick="modal('modal-md', '{{route('admin.listing.feature.edit',['prefix'=>'agent','id'=>$listing->id, 'feature_id'=>$feature->id])}}', '{{get_phrase('Update Feature')}}')" href="javascript:void(0);"> <i class="fas fa-pen"></i> </a>
            
                                                <a onclick="modal('modal-md', '{{route('admin.listing.sub-feature.add',['prefix'=>'agent','id'=>$listing->id, 'feature_id'=>$feature->id])}}', '{{get_phrase('Add New Sub Feature')}}')" href="javascript:void(0);"> <i class="fas fa-plus"></i> </a>
                                            </div>
                                        </h2>
                                            ...
                                            <ul>
                                                ...
                                                @foreach (App\Models\Listing_Feature::where('listing_id', $listing->id)->where('feature_id', $feature->id)->get() as $item)
                                                    <li class="p-2 ms-5 sub-feature">
                                                        <p> {{$i++}}. {{$item->title}} </p>
                                                        <div class="buttons">
                                                            <a onclick="modal('modal-md', '{{route('admin.listing.feature.edit',['prefix'=>'agent','id'=>$listing->id, 'feature_id'=>$item->id])}}', '{{get_phrase('Update Feature')}}')" href="javascript:void(0);"> <i class="fas fa-pen"></i> </a>
                                                            <a onclick="delete_modal('{{route('admin.listing.feature.delete',['prefix'=>'agent','id'=>$listing->id, 'feature_id'=>$item->id])}}')" href="javascript:void(0);" class=""> <i class="fas fa-trash"></i> </a>
                                                        </div>
                                                    </li>                                     
                                                @endforeach
                                            </ul>
