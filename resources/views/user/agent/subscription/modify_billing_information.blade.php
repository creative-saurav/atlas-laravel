...
@section('title', get_phrase('Subscription Renew'))
                    ...
                    <div
                        ...
                        <form id="update_form" action="{{ route('updateUserInfo') }}" method="post">
                            ...
                            <div class="dl_column_form d-flex flex-column rg-22">
                                ...
                                <div class="row justify-content-between align-items-center">
                                    <label
                                        ...
                                        class="col-sm-3 col-eForm-label"
                                ...
                                <!-- Country -->
                                <div class="row justify-content-between align-items-center">
                                    <label for="countries" class="col-sm-3 col-eForm-label"
                                ...
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-9">
                                        <select id="city" name="city" class="form-select eForm-select eChoice-multiple-without-remove" data-placeholder="Type to search...">
                                            ...
                                            @php
                                            $cities = App\Models\City::where('country', $address->country)->get();
                                            @endphp
                                            @foreach($cities as $key => $city)
                                            <option value="{{ $city->id }}" @if($address->city == $city->id) selected @endif>
                                            {{ $city->name }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="dl_form_btn d-flex justify-content-end g-20 pt-40">
                                <a href="javascript:{}" onclick="document.getElementById('update_form').submit();" class="eBtn saveChanges-btn mt-3">{{ get_phrase('Save Changes') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
