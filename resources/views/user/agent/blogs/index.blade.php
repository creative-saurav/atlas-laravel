            ...
            <div class="row gx-20px">
                ...
                <div class="col-lg-8 col-xl-9">
                    ...
                    <div class="d-flex align-items-start justify-content-between gap-2 mb-20px">
                        <div class="d-flex justify-content-between align-items-center gap-12px flex-column flex-lg-row w-100">
                        ...
                        <table class="table ca-table ca-table-width">
                            ...
                            <tbody class="ca-tbody">
                                ...
                                <tr class="ca-tr">
                                    ...
                                    <td>
                                        <img class="rounded" src="{{get_image('public/storage/blog-images/'.$blog->image)}}" width="50px" height="50px">
                                    </td>
                                    <td>
                                        <p class="ca-subtitle-14px ca-text-dark text-nowrap">{{$blog->title}}</p>
                                    </td>
                                    <td>
                                        <p class="ca-subtitle-14px ca-text-dark text-nowrap">{{$blog->keyword}}</p>
                                    </td>
                                    <td>
                                        <p class="ca-subtitle-14px ca-text-dark text-nowrap">
                                            
                                            @php
                                                $categorys = $categories->firstWhere('id', $blog->category);
                                            @endphp
