                    ...
                    <td> 
                        <div class="dropdown ol-icon-dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item fs-14px" onclick="edit_modal('modal-xl','{{route('admin.language-edit',['language'=>$item->name])}}','{{get_phrase('Update language')}}')" href="javascript:void(0);"> {{get_phrase('Edit')}} </a></li>
