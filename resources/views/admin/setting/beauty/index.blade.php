                            ...
                            <div class="box">
                                <div class="upload-options">
                                    @if(!empty($BeautyBanner->image))
                                        <img src="{{ asset('public/uploads/homepage/beauty/'. $BeautyBanner->image) }}" alt="" class="bg-dark_2 radious-15px px-2 py-2 beauty-preview h-200 cover w-100">
                                    @else
                            ...
                            <div class="box">
                                <div class="upload-options">
                                    @if(!empty($BeautyFacial->image))
                                        <img src="{{ asset('public/uploads/homepage/beauty/'. $BeautyFacial->image) }}" alt="" class="bg-dark_2 radious-15px px-2 py-2 cover beauty-facial-preview h-200 w-100">
                                    @else
                            ...
                            <div class="box">
                                <div class="upload-options">
                                    @if(!empty($BeautyMassage->image))
                                        <img src="{{ asset('public/uploads/homepage/beauty/'. $BeautyMassage->image) }}" alt="" class="bg-dark_2 radious-15px px-2 py-2 cover beauty-massage-preview h-200 w-100">
                                    @else
                            ...
                            <div class="box">
                                <div class="upload-options">
                                    @if(!empty($BeautyMotion->image))
                                        <img src="{{ asset('public/uploads/homepage/beauty/'. $BeautyMotion->image) }}" alt="" class="bg-dark_2 radious-15px px-2 py-2 beauty-motion-preview h-200 cover w-100">
                                    @else
