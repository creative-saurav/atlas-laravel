        ...
        @foreach ($countries as $country)
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="ol-card category-card radious-10px h-100">
                    <img src="{{ get_image('storage/app/public/country-thumbnails/'.$country->thumbnail) }}" class="card-img-top" alt="...">
                    ...
                    <div class="category-footer ol-card-body text-center py-1">
                        <a onclick="edit_modal('modal-md','{{route('admin.edit-country',['id'=>$country->id])}}','{{get_phrase('Edit Country')}}')" class="btn text-12px fw-600"><i class="fi fi-rr-pen-clip"></i> {{ get_phrase('Edit') }}</a>
                    </div>
                </div>
            </div>
        @endforeach
