...
<form action="{{route('admin.store.listing.room',['prefix'=>$user_prefix, 'id'=>$id])}}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="person" id="person" class="form-control ol-form-control" placeholder="{{get_phrase('Enter number of person (2 adult, 1 Child)')}}" required>
            </div>
            <div class="mb-3">
    ...
    <button type="submit" class="btn btn-primary fs-14"> {{get_phrase('Create')}} </button>      
</form>    
@elseif ($action == 'edit')
<form action="{{route('admin.update.listing.room',['prefix'=>$user_prefix,'id'=>$id,'room_id'=>$room->id])}}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="mb-3">
                <label for="person" class="form-label ol-form-label"> {{get_phrase('Number of persons')}}</label>
                <input type="text" name="person" id="person" class="form-control ol-form-control" value="{{$room->person}}" required>
            </div>
            <div class="mb-3">
                <label for="price" class="form-label ol-form-label"> {{get_phrase('Room Price')}}</label>
