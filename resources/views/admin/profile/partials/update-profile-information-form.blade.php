    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="flex items-center gap-4">
                <button type="submit" class="btn btn-primary fs-14px"> {{get_phrase('Save')}} </button>
            </div>
        </div>
        <div class="col-sm-6 pt-4">
            <img class="rounded mt-2" src="{{ get_image('storage/app/public/users/'.$user->image) }}" height="200px" alt="">
        </div>
    </div>
</form>
